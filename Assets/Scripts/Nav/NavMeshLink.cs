...
namespace UnityEngine.AI
{
    ...
    public class NavMeshLink : MonoBehaviour
    {
        ...
        {
            //hook up to my caves
        //    m_EndPoint = GameObject.Find("DungeonGenerator").GetComponent<DungeonManager>().startPos;
        ...
        void AddLink()
        {
         ...
         //   link.endPosition = GameObject.Find("DungeonGenerator").GetComponent<DungeonManager>().startPos;
